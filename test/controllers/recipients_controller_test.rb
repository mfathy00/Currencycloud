...
class RecipientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post recipients_url, params: { recipient: { name: @recipient.name, ref_recipient_id: @recipient.ref_recipient_id } }
    end
  ...
  test "should update recipient" do
    patch recipient_url(@recipient), params: { recipient: { name: @recipient.name, ref_recipient_id: @recipient.ref_recipient_id } }
